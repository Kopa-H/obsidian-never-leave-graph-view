...
const { DEFAULT_SETTINGS, GraphNodePreviewSettingsTab } = require('./settings');
const { previewLinkMethods } = require('./preview-links');
const { graphSpotlightMethods } = require('./graph-spotlight');
...
Object.assign(GraphNodePreviewPlugin.prototype, previewLinkMethods);
Object.assign(GraphNodePreviewPlugin.prototype, graphSpotlightMethods);
